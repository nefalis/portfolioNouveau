...
const ProjectCard = ({ title, description, stack, github, link, picture }) => {
    return (
        <div className="border-4 border-white rounded-xl shadow-md bg-gray-100 p-4 text-center transition-transform duration-200 ease-in-out hover:transform hover:translate-y-[-5px]">
            <div className="my-4">
...
const ProjectCardItem = () => {
    const categories = ['Back-end', 'Applications CLI', 'Front-end'];
