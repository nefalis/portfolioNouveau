...
const Header = ({ isOn, setIsOn }) => {
    return (
        <div 
            className={`border-8 border-white mx-auto shadow-md rounded-2xl max-w-[1200px] w-full ${isOn ? 'h-[300px]' : 'h-[300px]'} relative overflow-hidden transition-all duration-500`}
        >
            {/* Image de fond */}
            <img 
            ...
            <nav className="flex justify-center space-x-6 mt-6 relative font-bold">
            ...
            {/* Toggle Button */}
            <div className="relative flex justify-center p-0 md:p-2">
